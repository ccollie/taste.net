...
namespace Taste.Common
{
	...
	public class TasteException : Exception 
	{
		...
		public TasteException(Exception cause) : base(cause.Message, cause)
		{
		}

		public TasteException(String message, Exception cause) :base(message, cause)
		{			
		}
	}
}